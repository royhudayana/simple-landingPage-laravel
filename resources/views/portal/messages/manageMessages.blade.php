        ...
        <div class="col-xs-4">
            <div class="panel panel-white">
                ...
                <div class="panel-body">
                    {!! Form::open(['action' => 'smsMessageController@store', 'method' => 'post' ]) !!}
                            ...
                            @if(isset($messages))
                                @foreach($messages as $message)
                                    <tr>
                                        ...
                                        <th>
                                            {!! Form::open(['method'=>'put', 'route'=>['message.sendMessage',$message->id]]) !!}

                                                <button data-toggle="tooltip" data-placement="top" title="Send Message" type="submit" class="btn btn-success btn-block">{{$message->type}} | <i class="menu-icon fa fa-plane fa-1x"></i></button>
                                            {!! Form::close() !!}
                                        </th>
                                        <th>
                                            <div class="row">
